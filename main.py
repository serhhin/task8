...
def get_birthdays_per_week(users):
    ...
    def find_start_of_next_next_week():
        days_until_monday = (7 - today.weekday()) % 7
        find_start_of_next_next_week = today + timedelta(days=days_until_monday +5 )
        return find_start_of_next_next_week
    start_of_next_next_week = find_start_of_next_next_week()#2024-02-03
    ...
    for user in users:
        ...
        if birthday >= today + timedelta(days=7):
            ...
            # Якщо день народження не на наступній неділі , пропускаємо користувача.
            continue
        ...
        #if birthday < start_of_next_next_week :
